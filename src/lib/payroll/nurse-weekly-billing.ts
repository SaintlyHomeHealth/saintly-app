...
/**
 * Loads an existing weekly billing row for this period without creating one (for history / read-only views).
 */
export async function fetchNurseWeeklyBillingByPeriodOptional(
  applicantId: string,
  bounds: PayPeriodBounds
