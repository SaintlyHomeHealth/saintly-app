...
import type { PrivatePayInstructionGroup } from "@/lib/private-pay/payment-instructions";
 ...
 * Does not render diagnosis, Medicare, insurance, clinical notes, or internal notes.
 */
export function PublicInvoiceView({
  ...
  publicToken: string;
  instructions: PrivatePayInstructionGroup[];
}) {
