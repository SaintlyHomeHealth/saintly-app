...
import { MARKETING_NAV_SKILLED_NURSING_PAGE } from "./marketing-nav";

const IMG = {
  hero: "/marketing/caring_healthcare_at_home_setting.png",
  intro: "/marketing/nurse_consulting_with_patient_in_cozy_home.png",
  visit1: "/marketing/home_healthcare_consultation_in_cozy_setting.png",
  visit2: "/marketing/caring_hands_in_a_home_setting.png",
  team: "/marketing/healthcare_team_in_a_home_setting.png",
  trust: "/marketing/caring_hands_in_a_peaceful_home_setting.png",
} as const;

const HERO_IMAGE_ALT =
  "Saintly Home Health registered nurse providing a clinical assessment to a patient in a warm, sunlit living room";
...
const SERVICE_CARDS = [
  {
    ...
    body: "Head-to-toe assessments, vital signs, and ongoing monitoring of your condition at home.",
    icon: Stethoscope,
  },
  {
    title: "Medication support",
    body: "Medication review, teaching, and reminders to help patients stay safely on their plan.",
    icon: Pill,
  },
  {
    title: "Injections & infusions",
    body: "Skilled administration when ordered — including teaching for patients and caregivers.",
    icon: Syringe,
  },
  {
    title: "Condition monitoring",
    body: "Monitoring chronic conditions, post-acute recovery, vitals, and early warning signs.",
    icon: Activity,
  },
  {
    title: "Wound & clinical observation",
    body: "Dressing changes, wound monitoring, and clinical observation under physician orders.",
    icon: HeartPulse,
  },
  {
    title: "Physician coordination",
    body: "We obtain orders, share progress, and flag changes early so your doctor stays informed.",
    icon: ClipboardList,
  },
] as const;
...
const VISIT_INCLUDES = [
  ...
  "Wound and clinical observation",
  "Patient and caregiver education",
  "Updates to your physician",
...
const PROCESS_STEPS = [
  ...
  {
    title: "Skilled Care Begins at Home",
    body: "A licensed nurse visits the patient and builds a personalized plan of care.",
    icon: CalendarCheck,
  },
] as const;
...
const FAQS = [
  {
    q: "Is skilled nursing at home covered by Medicare?",
    a: "Medicare may cover skilled nursing at home when care is medically necessary, ordered by a physician, and the patient meets home health eligibility requirements. Coverage is determined by Medicare based on the individual's situation.",
  },
  {
    q: "Do I need a doctor's order for skilled nursing?",
    a: "Yes. Home health skilled nursing requires a physician/provider order and a face-to-face encounter that confirms the patient meets home health criteria.",
  },
  {
    q: "What conditions can a home health nurse help with?",
    a: "Common needs include post-hospital recovery, complex chronic conditions, wound care, medication management, IV therapy when ordered, and clinical monitoring after surgery or illness.",
  },
  {
    q: "How long does in-home nursing last?",
    a: "Episodes are individualized based on the patient's needs and progress. Your nurse re-evaluates regularly and updates the plan with the ordering physician.",
  },
  {
...
export function MarketingSkilledNursingPage() {
  return (
    <div
      className="min-h-screen w-full min-w-0 overflow-x-hidden pb-32 text-[#0c1929] md:pb-0"
      style={{ backgroundColor: CREAM }}
    >
      <MarketingSiteHeader navLinks={MARKETING_NAV_SKILLED_NURSING_PAGE} />

      {/* ─── Hero ─────────────────────────────────────────────────────────── */}
      <section
        className="relative overflow-hidden"
        aria-labelledby="sn-hero-heading"
        ...
        <div className="relative mx-auto grid w-full min-w-0 max-w-[88rem] gap-14 px-5 pb-24 pt-12 sm:gap-16 sm:px-7 sm:pb-28 sm:pt-16 md:gap-20 md:pb-32 md:pt-20 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:items-center lg:gap-x-20 lg:px-10 lg:pb-36 lg:pt-24 xl:gap-x-24 xl:pb-40 xl:pt-28">
          ...
          <div className="min-w-0 max-w-[40rem]">
            <div className="mb-9">
              ...
              <SectionEyebrow>Skilled Nursing · Saintly Home Health</SectionEyebrow>
            </div>
            ...
            <p className="mt-9 max-w-[36rem] text-[1.32rem] leading-[1.6] text-slate-700 sm:mt-11 sm:text-[1.42rem] sm:leading-[1.6] md:text-[1.55rem] md:leading-[1.6]">
              Licensed nurses providing assessments, medication support, condition monitoring, and
              physician-coordinated care — right where patients heal best.
            </p>
          ...
          <div className="relative mx-auto min-w-0 w-full max-w-2xl lg:mx-0 lg:max-w-none">
            ...
            <div className="absolute -bottom-6 left-4 hidden items-center gap-3 rounded-2xl border border-white/90 bg-white/95 px-5 py-4 shadow-[0_24px_56px_-22px_rgba(15,23,42,0.30)] backdrop-blur-sm sm:flex lg:left-8 lg:-bottom-10">
              ...
              <GoldIconTile size="md">
                <Stethoscope className="h-7 w-7" strokeWidth={1.9} aria-hidden />
              </GoldIconTile>
      ...
      <section
        ...
        style={{ backgroundColor: CREAM }}
        aria-labelledby="sn-intro-heading"
      >
        <div
          ...
          <div className="relative grid min-w-0 items-stretch gap-0 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)]">
            <div className="relative flex min-w-0 flex-col justify-center gap-6 px-7 py-12 sm:px-10 sm:py-14 lg:px-14 lg:py-16">
              <div>
                ...
                <SectionEyebrow>Skilled care, brought home</SectionEyebrow>
                <h2
                  id="sn-intro-heading"
                  ...
                  style={{ color: NAVY }}
                >
                  Clinical care led by experienced nurses — at home
                </h2>
                <p className="mt-6 text-[1.18rem] leading-[1.7] text-slate-700 sm:text-[1.28rem]">
                  Saintly nurses provide skilled clinical care under physician orders — assessing
                  conditions, supporting medications, and keeping your doctor informed every step
                  of the way.
                </p>
              </div>
              <ul className="grid gap-3 sm:grid-cols-2 sm:gap-x-5 sm:gap-y-4">
                {[
                  "Licensed RN/LVN clinicians",
            ...
            <div className="relative aspect-[16/11] min-w-0 w-full overflow-hidden bg-amber-50 lg:aspect-auto lg:min-h-[440px] lg:rounded-r-[2.5rem]">
              <Image
                src={IMG.intro}
                alt="Saintly nurse reviewing a recovery plan with an older patient and family member at home"
                fill
      ...
      <section
        ...
        aria-labelledby="sn-services-heading"
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <SectionEyebrow>What skilled nursing covers</SectionEyebrow>
          <h2
            id="sn-services-heading"
            className="mt-5 text-balance text-[clamp(2rem,4.5vw,3.25rem)] font-semibold leading-[1.08] tracking-[-0.03em]"
            style={{ color: NAVY }}
          >
            How skilled nursing supports patients at home
          </h2>
        </div>
      ...
      {/* ─── What a nursing visit can include — collage panel ─────────────── */}
      <section
        className="relative overflow-x-hidden px-5 py-[clamp(5.75rem,13vw,8.75rem)] sm:px-7 lg:px-10"
        aria-labelledby="sn-visit-heading"
        style={{ background: BG_CREAM_GOLD }}
      >
        <div
          className="relative mx-auto max-w-[84rem] overflow-hidden rounded-[2.25rem] border border-amber-100/80 shadow-[0_54px_120px_-44px_rgba(15,23,42,0.30)] md:rounded-[2.5rem]"
        ...
        >
          ...
          <div className="relative grid min-w-0 items-stretch gap-0 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)]">
            <div className="relative px-5 pt-9 pb-2 sm:px-9 sm:pt-12 lg:px-12 lg:py-12">
              <div className="relative mx-auto w-full max-w-[34rem] lg:max-w-none">
                <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[1.85rem] bg-amber-50 shadow-[0_44px_100px_-40px_rgba(15,23,42,0.32)] ring-1 ring-white/85 sm:aspect-[5/4] md:rounded-[2rem] lg:aspect-[4/5]">
                  <Image
                    src={IMG.visit1}
                    alt="Saintly nurse reviewing a recovery plan on a tablet with patient and family"
                    fill
                ...
                <div className="relative mt-5 ml-auto w-[68%] max-w-[18rem] sm:absolute sm:-bottom-8 sm:-right-4 sm:mt-0 sm:w-[60%] sm:max-w-[20rem] lg:-bottom-10 lg:-right-6">
                  <div className="relative aspect-[5/4] w-full overflow-hidden rounded-[1.5rem] border-[3px] border-white bg-amber-50 shadow-[0_30px_70px_-28px_rgba(15,23,42,0.40)] sm:rounded-[1.75rem]">
                    <Image
                      src={IMG.visit2}
                      alt="Saintly clinician's caring hands providing gentle bedside care at home"
                      fill
            ...
            <div className="relative flex min-w-0 flex-col justify-center gap-7 px-7 py-12 sm:px-10 sm:py-14 lg:px-14 lg:py-16">
              <div>
                <HaloMark className="mb-4 block" width={92} height={28} />
                <SectionEyebrow>During a nursing visit</SectionEyebrow>
                <h2
                  id="sn-visit-heading"
                  className="mt-5 text-balance text-[clamp(2rem,3.8vw,3rem)] font-semibold leading-[1.08] tracking-[-0.028em] sm:text-[clamp(2.2rem,3.4vw,3.35rem)]"
                  style={{ color: NAVY }}
                >
                  What a skilled nursing visit can include
                </h2>
                <p className="mt-6 text-[1.18rem] leading-[1.7] text-slate-700 sm:text-[1.28rem]">
                  Practical, physician-directed care focused on what the patient needs to recover
                  and stay well at home.
                </p>
              </div>
      ...
      <section
        ...
        aria-labelledby="sn-team-heading"
        style={{ backgroundColor: CREAM }}
      >
        <div
          className="relative mx-auto max-w-[84rem] overflow-hidden rounded-[2.25rem] border border-amber-100/80 shadow-[0_54px_120px_-44px_rgba(15,23,42,0.30)] md:rounded-[2.5rem]"
        ...
        >
          ...
          <div className="relative grid min-w-0 items-stretch gap-0 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1fr)]">
            ...
            <div className="relative flex min-w-0 flex-col justify-center gap-6 px-7 py-12 sm:px-10 sm:py-14 lg:px-14 lg:py-16">
              <div>
                <HaloMark className="mb-4 block" width={92} height={28} />
                <SectionEyebrow>Our nursing team</SectionEyebrow>
                <h2
                  id="sn-team-heading"
                  className="mt-5 text-balance text-[clamp(2rem,3.8vw,3rem)] font-semibold leading-[1.08] tracking-[-0.028em] sm:text-[clamp(2.2rem,3.4vw,3.35rem)]"
                  style={{ color: NAVY }}
                >
                  Trusted clinical care at home
                </h2>
                <p className="mt-6 text-[1.18rem] leading-[1.7] text-slate-700 sm:text-[1.28rem]">
                  Our nurses coordinate directly with your physician so updates, orders, and
                  progress stay clear for patients and families.
                </p>
              </div>
              <ul className="grid gap-3 sm:grid-cols-2 sm:gap-x-5 sm:gap-y-4">
                {[
      ...
      <section
        className="relative overflow-x-hidden px-5 py-[clamp(5.75rem,13vw,8.75rem)] sm:px-7 lg:px-10"
        style={{ backgroundColor: CREAM }}
        aria-labelledby="sn-coverage-heading"
      >
        <div
          ...
          <div className="relative grid min-w-0 gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-start lg:gap-16">
            <div className="min-w-0">
              ...
              <h2
                ...
                style={{ color: NAVY }}
              >
                Medicare May Cover Skilled Nursing at Home
              </h2>
              <p className="mt-7 text-[1.22rem] leading-[1.7] text-slate-800 sm:text-[1.32rem] sm:leading-[1.72]">
                Skilled nursing may be covered by Medicare when ordered by a physician and when
                the patient meets home health eligibility requirements. Saintly Home Health helps
                coordinate the referral, orders, and documentation so the process is smoother
      ...
      <section
        className="relative overflow-x-hidden px-5 py-[clamp(5.75rem,13vw,8.75rem)] sm:px-7 lg:px-10"
        aria-labelledby="sn-process-heading"
      ...
      <section
        ...
        aria-labelledby="sn-faq-heading"
        style={{ background: BG_CREAM_SOFT }}
      >
        <div
      ...
      <section
        ...
        aria-labelledby="sn-final-cta-heading"
