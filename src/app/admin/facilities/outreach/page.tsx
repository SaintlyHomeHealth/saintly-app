...
import { FacilityOutreachViewClient } from "@/app/admin/facilities/_components/FacilityOutreachViewClient";
...
export default async function FacilityOutreachPage() {
  ...
  return (
    <div className="w-full min-w-0 space-y-6 p-4 sm:p-6">
      ...
      <FacilityOutreachViewClient showManagerAnalyticsLink={showAdmin} currentUserId={staff.user_id} />
    </div>
  );
}
