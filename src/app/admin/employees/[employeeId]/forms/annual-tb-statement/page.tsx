import AnnualTbStatementForm from "@/components/admin/forms/annual-tb-statement-form";

export default async function AnnualTbStatementPage({
  params,
  searchParams,
}: {
