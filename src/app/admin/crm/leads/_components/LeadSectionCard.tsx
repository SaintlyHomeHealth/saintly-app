...
export function LeadSectionCard({ id, title, description, children, className = "" }: LeadSectionCardProps) {
  return (
    <section
      id={id}
      className={`scroll-mt-36 rounded-2xl border border-slate-200/90 bg-gradient-to-b from-white to-slate-50/90 p-6 shadow-[0_1px_3px_rgba(15,23,42,0.06)] ring-1 ring-slate-200/60 sm:p-8 ${className}`}
    >
