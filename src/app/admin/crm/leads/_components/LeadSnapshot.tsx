...
export function LeadSnapshot(props: LeadSnapshotProps) {
  ...
  return (
    <section
      id="section-snapshot"
      className="scroll-mt-44 rounded-[28px] border border-slate-200/90 bg-gradient-to-b from-white via-slate-50/40 to-slate-50/80 p-5 shadow-[0_8px_30px_rgba(15,23,42,0.06)] ring-1 ring-slate-200/60 sm:p-7"
    >
