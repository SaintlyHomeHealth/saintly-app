...
export function WorkspacePhoneHeaderChrome({ children }: Props) {
  ...
  return (
    <header
      className={`sticky top-0 z-30 border-b border-sky-100/70 bg-white/95 px-3 pb-1.5 pt-[calc(0.45rem+env(safe-area-inset-top,0px))] shadow-[0_4px_24px_-12px_rgba(30,58,138,0.08)] backdrop-blur-md supports-[backdrop-filter]:bg-white/90 sm:px-4 sm:pb-2 sm:pt-[calc(0.65rem+env(safe-area-inset-top,0px))] lg:pb-2 lg:pt-[calc(0.5rem+env(safe-area-inset-top,0px))] ${
        inboxListDesktop
