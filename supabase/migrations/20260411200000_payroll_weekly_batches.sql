...
--
-- If this migration fails partway, apply 20260411210000_payroll_weekly_batches_safe_patch.sql
-- (idempotent preflight + diagnostics). Do not edit this file after deploy without a new migration.
